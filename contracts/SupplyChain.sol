...
contract SupplyChain {
  ...
  modifier checkValue(uint _sku) {
    ...
    _buyer.transfer(_amountToRefund);
  ...
  constructor() public {
    ...
    // 2. Initialize the sku count to 0.  is this necessary? No
    owner = msg.sender;
  }
  ...
  function buyItem(uint _sku) public 
    payable forSale(_sku)
